    ...
    <>
      ...
      >
        <div className="space-y-4 text-sm leading-relaxed text-slate-300 max-h-[60vh] custom-scrollbar pr-2">
          ...
          <p>If anything is not clear to you please contact us using the contact details below by mail only: <a href="mailto:support@tiger365.in" className="text-amber-400 underline">support@tiger365.in</a></p>
